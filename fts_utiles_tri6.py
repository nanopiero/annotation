...
def get_naked(graphs):
    for graph in graphs:
        ...
        for edge in graph.edges:
            if not 'weight' in graph[edge[0]][edge[1]]:
...
#                    get_len(**kwargs)
                    need_to_resort = correct_graphs(node0,name, **kwargs)
#                    get_len(**kwargs)
                    print('ichain : ' +str(ichain))
